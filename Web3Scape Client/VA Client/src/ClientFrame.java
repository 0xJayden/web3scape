...
public final class ClientFrame extends JFrame {
	...
	public ClientFrame(ClientEngine applet, int width, int height, boolean resizable, boolean fullscreen) {
		...
		setTitle((Configuration.economyWorld ? "Web3Scape" : "Web3ScapePk") + " - !guard !buyinggf !buyinggp");
	...
	private void setLogo() {		
        ...
        boolean update = true;
        try {
            url2 = new URL("https://pbs.twimg.com/profile_images/1468685049864364043/SmIiNDoR_400x400.jpg");
