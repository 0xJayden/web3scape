...
public class GlobalMessages {
	...
	public static final String[] ANNOUNCEMENTS = { 
		...
		"Do you love Web3Scape? Please show us some love by donating!",
		"Want to disable TriviaBot? Or add a notification bar? ::triviasettings",
		"Considering donating? Donors have access to many custom content!",
		"Considering donating? Donors will be given membership status.",
		"Members can change their title by speaking to Dunce at Memberzone.",
		"Having an issue with your account? Tell us about it on discord.",
		"Do you have an interesting idea? Suggest it to us in discord!",
		"Found a bug? Report it on discord and we will fix it for you!",
		"Did you know you can talk to Big Mo at home for a title?",
		"Our website is located at http://www.Web3Scape.com!",
	};
