...
public enum VencillioBotData {	
	  DATA_1("Who is the CEO of Web3Scape?", "dumbledoor"),
	  ...
	  DATA_5("How many developers are there of Web3Scape?", "5", "five"),
	  DATA_6("Which MOB has four enourmous tentacles?", "Kraken", "kraken"),
	  DATA_7("How many crystal keys do you get for voting for Web3Scape?", "3", "Three"),
	  DATA_8("I am a rock that turns into a crab what am i called?", "Rock crab", "Rock crabs"),
	  DATA_9("What is the max level possible reached in any Web3Scape skill?", "99"),
	  DATA_10("Which NPC allows you set bank pin in Web3Scape?", "Web3Scape guard", "guard"),
	  DATA_11("In Web3Scape how many NPCs drop the Chaos Elemental pet?", "2", "two"),
	  ...
	  DATA_17("What is the max combat level you can achieve in Web3Scape?", "126"),
	  ...
	  DATA_23("How many waves is fight caves in Web3Scape?","fifteen", "15"),
	  ...
	  DATA_27("How many friends fit on the Web3Scape friendslist?", "200"),
	  ...
	  DATA_34("Which npc teleports you to rune essence mine in Web3Scape?", "Mage of zamorak", "Zamorak mage"),
	  DATA_35("What is the required level for Smite?", "52"),
	  DATA_36("How many times can you prestige one stat in Web3Scape?", "5", "five"),
	  DATA_37("Which gamemode in Web3Scape cannot use banks?", "Ultimate Ironman", "Ult"),
	  ...
	  DATA_43("Type this backwards; Web3ScapeisthebestForsure", "erusroftsebehtsiepacS3beW"),
	  DATA_44("How much does regular membership cost?", "$5", "5 dollars", "5 dollar"),
	  DATA_45("How many tiers of membership are there?", "4", "four"),
	  DATA_46("What game is wildly addictive?", "Web3Scape", "this game", "WnD", "Wizards and Dragons"),
	  DATA_47("What NPC helps Iron accounts?", "adam"),
	  DATA_48("Name one of Web3Scape's moderators.", "Hagrid", "normie"),
	  DATA_49("Who is the community manager for Web3Scape?", "unknown"),
	  DATA_50("Name one of Web3Scape's developers", "0xJayden", "WizardDev", "longbottom", "dumbledoor", "haoryan"),
	  ...
	  DATA_56("Where is home in Web3Scape?", "the tower"),
	  ...
	  DATA_59("What is the name of the NPC used to travel around Web3Scape?", "sailor"),
	  ...
	  DATA_62("What NPC allows you to reset combat stats in Web3Scape?", "genie"),
	  ...
	  DATA_66("Who is the website developer?", "bigshot", "Ken"),	  
	  ...
	  DATA_71("How many letters are in the word 'Web3Scape'?", "9", "nine"),  
