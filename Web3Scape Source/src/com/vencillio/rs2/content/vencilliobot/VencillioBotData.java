...
public enum VencillioBotData {	
	  DATA_1("Who is the CEO of Vencillio?", "daniel"),
	  ...
	  DATA_5("How many developers are there of Vencillio?", "4", "four"),
	  DATA_6("Which MOB has four enourmous tentacles?", "Kraken", "kraken"),
	  DATA_7("How many crystal keys do you get for voting for Vencillio?", "3", "Three"),
	  DATA_8("I am a rock that turns into a crab what am i called?", "Rock crab", "Rock crabs"),
	  DATA_9("What is the max level possible reached in any Vencillio skill?", "99"),
	  DATA_10("Which NPC allows you set bank pin in Vencillio?", "Vencillio guard", "guard"),
	  DATA_11("In Vencillio how many NPCs drop the Chaos Elemental pet?", "2", "two"),
	  ...
	  DATA_17("What is the max combat level you can achieve in Vencillio?", "126"),
	  ...
	  DATA_23("How many waves is fight caves in Vencillio?","fifteen", "15"),
	  ...
	  DATA_27("How many friends fit on the Vencillio friendslist?", "200"),
	  ...
	  DATA_34("Which npc teleports you to rune essence mine in Vencillio?", "Mage of zamorak", "Zamorak mage"),
	  DATA_35("What is the required level for Smite?", "52"),
	  DATA_36("How many times can you prestige one stat in Vencillio?", "5", "five"),
	  DATA_37("Which gamemode in Vencillio cannot use banks?", "Ultimate Ironman", "Ult"),
	  ...
	  DATA_43("Type this backwards; VencillioisthebestForsure", "erusroftsebehtsioillicnev"),
	  DATA_44("How much does regular membership cost?", "$5", "5 dollars", "5 dollar"),
	  DATA_45("How many tiers of membership are there?", "4", "four"),
	  DATA_46("What game is wildly addictive?", "vencillio", "this game"),
	  DATA_47("What NPC helps Iron accounts?", "adam"),
	  DATA_48("Name one of Vencillio's moderators.", "saga", "grim", "narcan"),
	  DATA_49("Who is the community manager for Vencillio?", "synergy"),
	  DATA_50("Name one of Vencillio's developers", "daniel", "chex", "zion", "complex"),
	  ...
	  DATA_56("Where is home in vencillio?", "edgeville"),
	  ...
	  DATA_59("What is the name of the NPC used to travel around Vencillio?", "sailor"),
	  ...
	  DATA_62("What NPC allows you to reset combat stats in Vencilio?", "genie"),
	  ...
	  DATA_71("How many letters are in the word 'Vencillio'?", "9", "nine"),  
